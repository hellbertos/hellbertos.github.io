...
var bio = {
    ...
    "welcomeMsg" : "I am a front end web developer and  web designer with a passion for creating accessible, informative and aesthetically pleasing web sites. I am continually striving to learn and progress in all phases of the craft.  As web technologies change, I keep updated by learning about the latest technologies.<br><br>I hand code HTML and CSS. I've been incorporating SASS into my workflow. I ustilize Git when it fits in to my process. I use mainly Jquery, but don't hesitate to use vanilla JS when it makes sense to manipulate the DOM. I'm coming up to speed on the layout mode of Flex Box as it's support on mobile platforms and the desktop grows. I build most of my sites on the Wordpress framework so my PHP coding is generally implemented using the WP API.<br><br>Where design is concerned, I endeavor to approach each new project from a UX perspective coming from a foundation of existing content and desired user flow. Clean, unobtrusive and functional best describes my design directive.",
